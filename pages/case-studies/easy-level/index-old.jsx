            ...
            <div className="container">
              <div className="row">
                ...
                <div className="img-blk">
                  <img src="/images/case-studies/easylevel/easy-level-banner.svg" alt="" />
                </div>
              </div>
            </div>
          </div>
...
All Founders, Moderators, Advertisers, and Users can all feature on Easy-Level with Metamask or private key on Mobile devices.
                ...
                <div className="col-md-6 sticky-image-section">
                  <div className="speakinc-img sticky-img">
                    <img src="/images/case-studies/easylevel/easy-level-sticky.svg" alt="Speakinc Intro Image" />
                  </div>
                </div>
              </div>
            </div>
                      ...
                      <Slider {...settings} className="slide-outer">
                        ...
                        <div className="slide-div">
                          <div className="slider-img">
                            <img src="/images/case-studies/easylevel/easy-level-slider.svg" alt="" />
                          </div>
                        </div>
                        <div className="slide-div">
                          <div className="slider-img">
              ...
              <div className="row justify-content-center">
                <div className="col-md-10 col-lg-8 col-xl-8">
                  <div className="project-blk-title text-center">
                    ...
                    <h3 class="main-title title-orange">Our Blockchain skills sets</h3>
                  </div>
              ...
              <div className="row">
                <div className="col-md-5 offset-md-1">
                  <div className="project-unique-wrap">
                    ...
                    <div className="cust-order-list cust-order-list-no-count">
                      <ul>
                        <li><strong><span className="title-orange">Front-end</span>  Front-end  React/Redux-thunk, Web3 </strong><p className="mt-2">Front-end with React/Redux-thunk, Web3(integration between the smart contracts and website)</p> </li>
                        <li><strong><span className="title-orange">Back-end</span>  Python/Django, Web3 </strong><p className="mt-2">Back-end with Python/Django, Web3(integration between the smart contracts and the private keys from users)</p></li>
                        <li><strong className="title-orange">NodeJS/SocketIO</strong><p className="mt-2">Easy-Level updates transaction info real time. SocketIO is being broadcasted to the UI whenever there is an update on Easy-Level.</p> </li>
                        <li><strong><span className="title-orange">Database</span>  MySQL</strong><p className="mt-2">Transaction history, activities from viewers and clickers and registered users are being managed by DB. </p></li>
                        <li><strong><span className="title-orange">DevOps</span>  Git CI/CD pipeline and Docker</strong><p className="mt-2">On gitlab, I have built a CI/CD pipeline based on Docker repositories. DevOps works automatically passing `dev` and `test` stages to update `production` server.</p> </li>
                        <li><strong><span className="title-orange">Smart Contracts</span>  Solidity</strong><p className="mt-2">We have used Provable and Oracle to integrate 3rd party API to fetch data like price rate, allowance from Easy-Level, and so on.</p> </li>
                        <li><strong><span className="title-orange">Audit</span>  Zeppelin </strong><p className="mt-2">We also have used Zeppelin to audit Smart Contracts. I have implemented test cases on it and always ran them to audit Smart Contracts.</p> </li>
                ...
                <div className="col-md-6 align-self-end">
                  ...
                  <div className="hand-img-blk">
                    <img src="/images/case-studies/easylevel/easy-level-phone-mockup.svg" alt="" />
                  </div>
                  </Slide>
                </div>
              </div>
              ...
              <div className="row justify-content-center">
                <div className="col-md-8">
                  <div className="project-blk-title">
                    ...
                    <img className="mb-2" src="../images/shopify/shopify-quoute.svg"/>
                  </div>
