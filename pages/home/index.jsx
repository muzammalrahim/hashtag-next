...
const Sunnyvalemap = dynamic(() => import("./Sunnyvalemap"), { ssr: false });
const Sanjosemap = dynamic(() => import("./Sanjosemap"), { ssr: false });
const Sandiegomap = dynamic(() => import("./Sandiegomap"), { ssr: false });
const Kochi = dynamic(() => import("./Kochi"), { ssr: false });
              ...
              <div className="col-12  section-three-text">
                ...
                <div className="row mt-5">
                  <div className="col-lg-4 col-sm-12 mob-padding">
                    <div className="what-we-do-border-style what-we-do-responsive">
                      <img
                        src="images/business-process-automation.svg"
                  ...
                  <div className="col-lg-4 col-sm-12 mob-padding">
                    <div className="what-we-do-border-style what-we-do-responsive">
                      <img
                        src="images/web-application.svg"
                        alt="web-application"
                      />
                ...
                <div className="row justify-content-center mt-5 mob-padding">
                  ...
                  <div className="col-offset-lg-2 col-lg-4 col-sm-12  mob-padding">
                    <div className="what-we-do-border-style what-we-do-responsive">
                      <img
                        src="images/Creative conceptual.svg"
                        alt="creative_design"
                      />
                      <p className="text-level-4">
                ...
                <div className="col-12 col-lg-3 col-md-6 why-us-first-section">
                  ...
                  <Slide bottom>
                    <div className="why-us-box">
                      <div className="why-us-icon why-icon-mobile">
                        <img
                          src="images/home/why-us/chat.svg"
                          alt="communication"
                        />
                      </div>
                      <p className="title-level-6 title-level-mobile">
                ...
                <div className="col-12 col-lg-3 col-md-6 why-us-second-section">
                    ...
                    <div className="why-us-box">
                      <div className="why-us-icon why-icon-mobile">
                        <img
                          ...
                          src="images/home/why-us/equality.svg"
                          alt="quality"
                        />
                      </div>
                      <p className="title-level-6 title-level-mobile">
                  ...
                  <Slide bottom>
                    <div className="why-us-box">
                      <div className="why-us-icon why-icon-mobile">
                        <img
                          src="images/home/why-us/process.svg"
                          alt="process"
                        />
                      </div>
                      <p className="title-level-6 title-level-mobile">
                  ...
                  <Slide bottom>
                    <div className="why-us-box">
                      <div className="why-us-icon why-icon-mobile">
                        <img
                          src="images/home/why-us/support.svg"
                          alt="support"
                        />
                      </div>
                      <p className="title-level-6 title-level-mobile">
        ...
        <div className="container-fluid section-five-bg  pb-5">
          <div className="container">
            ...
            <div className="desktop-only-expertise d-none d-sm-block">
              {" "}
              <div className="row justify-content-center mt-2 homePageImgs">
                <div className="col-lg-2 col-md-2 col-sm-12 text-center my-auto d-flex pt-5">
                  <img
                    src="images/home/html5.svg"
                    alt="html5"
                    className="img-fluid mx-auto my-auto homePageImgs "
                  />
                </div>
                <div className="col-lg-2 col-md-2 col-sm-12 text-center my-auto d-flex pt-5">
                  <img
                    src="images/home/mysql.svg"
                    alt="mysql"
                    className="img-fluid mx-auto my-auto homePageImgs"
                  />
                </div>
              ...
              <div className="row justify-content-center  mt-2">
                ...
                <div className="col-lg-2 col-md-2 col-sm-12 text-center my-auto d-flex pt-5">
                  <img
                    src="images/home/angular-js.svg"
                    alt="angular_js"
                    className="img-fluid mx-auto my-auto homePageImgs"
                  />
                </div>
              ...
              <div className="row justify-content-center  mt-2">
                ...
                <div className="col-lg-2 col-md-2 col-sm-12 text-center my-auto d-flex pt-5">
                  <img
                    src="images/home/codeigniter.svg"
                    alt="codeigniter"
                    className="img-fluid mx-auto my-auto homePageImgs"
                  />
                </div>
