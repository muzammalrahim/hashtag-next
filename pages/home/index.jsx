...
{console.log(this.props)}
											...
											<a className="sol-but-ab" href="/services">
											    <div className="btn-group">
													  ...
													  <button type="button" className="btn  px-3">
														 <span className=""><span className="hashtag-arrow btn-down-arrow"></span></span> 
													  </button>
      ...
      <div className="container-fluid who-we-section" >
		  ...
		  <div className="col-12 col-sm-12 col-lg-4 col-xxl-3 who-we-left-bg d-none d-md-none d-lg-block" id="who-we-section"></div>
		  ...
		  <div className="col-12 col-sm-12 col-lg-4 col-xxl-3 who-we-are-middle-text-2">
						...
						<p className="hash-content-col">Hashtag Systems Inc, an international Software 
						development and outsourcing company with its headquarters 
						in Sunnyvale, California and development centers in San Diego, 
						California & Kochi</p>
						<p className="nj-who-we-are-sub-content mt-5">Our team is set to chase innovation in 
						every stride and revolutionize the world of software in order to deliver the best to our clients worldwide. <br/>
						We deliver custom software development projects geared to surpass the expectations of our 
						clients. Lets create responsive applications that adapt to your customers’ habits</p>
						<a href="/about-us" className="nj-who-we-are-button float-right font-12 font-bold mt-4">read more <span className="nj-arrow"><span className="hashtag-arrow btn-right-arrow"></span></span></a>
             ...
             <div classname="section-four-left-bg">
				<div className="container section-four-content">
					...
					<div className="row justify-content-center  pl-3 pr-3">
						...
						<p className="pt-4">We believe our customers deserve the best and quality is something we dare not to compromise! </p>
						<p className="pt-2">We ensure impeccable service right from the second we receive the demand from our valuable customer. </p>
						<p className="pt-2"> Our maintenance and support team would ensure the same even after we deliver the product. </p>
			 ...
			  				<div className="col-lg-6 col-md-12 col-sm-12">
								<nav>
									<div className="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
										<a className="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Sunnyvale</a>
										<a className="nav-item nav-link" id="nav-sanjose-tab" data-toggle="tab" href="#nav-sanjose" role="tab" aria-controls="nav-sanjose" aria-selected="true">San Jose</a>
										<a className="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">San Diego</a>
										<a className="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Kochi</a>
										
									</div>
								</nav>
								</div>
							<div className="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
										<div className="tab-pane fade show active text-left pl-3" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
											<div className="row tab-content">
												<div className="col-lg-6 col-md-12 col-sm-12">	
													<img src="images/home/location.svg" alt="location" className="address-icons"/> <span className="address-content">Sunnyvale</span>
													<address className="address-text">100 S. Murphy Ave. Suite 200<br/>
																Sunnyvale, CA 94086<br/>
																USA
													</address>
													<img src="images/home/phone.svg" alt="phone" className="address-icons"/> <span className="address-content">PHONE</span>
													<p className="address-text"><a href="tel:+1-408-596-2525">+1 408 596 2525</a></p>
													<img src="images/home/email.svg" alt="email" className="address-icons"/> <span className="address-content">EMAIL</span>
													<p className="address-text"> <a href="mailto:info@hashtag-ca.com" className="link-mail">info@hashtag-ca.com</a></p>
													<span className="address-content">FOLLOW US </span><a href="https://www.linkedin.com/company/hashtag-systems-inc/" target="_blank"><img src="images/home/linkedin.svg" className="pl-2 pr-2 contact-linkedin"/></a><a href="https://www.facebook.com/hashtagsystemsca/" target="_blank"><img src="images/home/facebook-logo.svg" className="conatct-fb"/></a>
												</div>
												<div className="col-lg-6 col-md-12 col-sm-12">
									  				<div className="hash-map h-100">
									  					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3170.5289063403397!2d-122.03185048529588!3d37.37732237983374!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x808fb65cf6471b75%3A0x8a1d78f6bdfb3110!2sHashtag%20Systems%20Inc%20-%20Web%20development%20company!5e0!3m2!1sen!2sin!4v1599470282095!5m2!1sen!2sin" className="map-image"></iframe>
									  					
									  				</div>
				  								</div>
			  								</div>
					        			 </div>
					        				 <div className="tab-pane fade text-left pl-3" id="nav-sanjose" role="tabpanel" aria-labelledby="nav-sanjose-tab">
											<div className="row tab-content">
												<div className="col-lg-6 col-md-12 col-sm-12">	

												<img src="images/home/location.svg" alt="location" className="address-icons"/> <span className="address-content">San Jose</span>
												<address className="address-text">
99 S Almaden Blvd Suite<br/>
600 San Jose, CA 95113<br/>
USA
												...
												<img src="images/home/phone.svg" alt="phone" className="address-icons"/> <span className="address-content">PHONE</span>
												<p className="address-text"><a href="tel:+1-408-404-7323">+1 408 404 7323</a></p>
												<img src="images/home/email.svg" alt="email" className="address-icons"/> <span className="address-content">EMAIL</span>
												<p className="address-text"><a href="mailto:sjc@hashtag-ca.com" className="link-mail">sjc@hashtag-ca.com</a></p>
												<span className="address-content">FOLLOW US </span><a href="https://www.linkedin.com/company/hashtag-systems-inc/" target="_blank"><img src="images/home/linkedin.svg" className="pl-2 pr-2 contact-linkedin"/></a><a href="https://www.facebook.com/hashtagsystemsca/" target="_blank"><img src="images/home/facebook-logo.svg" className="conatct-fb"/></a>
											</div>
												<div className="col-lg-6 col-md-12 col-sm-12">
									  				<div className="hash-map h-100">

									  					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3172.428428473099!2d-121.89654558515603!3d37.332364645262906!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x808fcca46fe2751d%3A0xac22cd23368a6885!2s99%20S%20Almaden%20Blvd%20%23600%2C%20San%20Jose%2C%20CA%2095113%2C%20USA!5e0!3m2!1sen!2sin!4v1604491251986!5m2!1sen!2sin" className="map-image"></iframe>
									  					
									  				</div>
				  								</div>
				  							</div>
										</div>										
										<div className="tab-pane fade text-left pl-3" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
											<div className="row tab-content">
												<div className="col-lg-6 col-md-12 col-sm-12">	
	
												<img src="images/home/location.svg" alt="location" className="address-icons"/> <span className="address-content">San Diego</span>
												<address className="address-text">7770 Regents Rd. #113-385<br/>
												San Diego, CA 92122, <br/>USA
												</address>
												
												<img src="images/home/email.svg" alt="email" className="address-icons"/> <span className="address-content">EMAIL</span>
												<p className="address-text"><a href="mailto:info.SD@hashtag-ca.com" className="link-mail">info.SD@hashtag-ca.com</a></p>
												<span className="address-content">FOLLOW US </span><a href="https://www.linkedin.com/company/hashtag-systems-inc/" target="_blank"><img src="images/home/linkedin.svg" className="pl-2 pr-2 contact-linkedin"/></a><a href="https://www.facebook.com/hashtagsystemsca/" target="_blank"><img src="images/home/facebook-logo.svg" className="conatct-fb"/></a>
												</div>
												<div className="col-lg-6 col-md-12 col-sm-12">
									  				<div className="hash-map h-100">
													...
													<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3351.3362449183883!2d-117.22655108533353!3d32.8628218869136!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80dc012bd2a9e523%3A0x9bf6efa5cf00201d!2s7770%20Regents%20Rd%2C%20San%20Diego%2C%20CA%2092122%2C%20USA!5e0!3m2!1sen!2sin!4v1599480789688!5m2!1sen!2sin" className="map-image" ></iframe>
									  					
									  				</div>
				  								</div>
				  							</div>
										</div>
										<div className="tab-pane fade text-left pl-3" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
											<div className="row tab-content">
												<div className="col-lg-6 col-md-12 col-sm-12">	

												<img src="images/home/location.svg" alt="location" className="address-icons"/> <span className="address-content">Kochi</span>
												<address className="address-text">
													Infopark Technology Business Center
													JNI Stadium, <br/>Kaloor,<br/> Kerala, India<br/>
														
												</address>
												<img src="images/home/phone.svg" alt="phone" className="address-icons"/> <span className="address-content">PHONE</span>
												<p className="address-text"><a href="tel:+91-9207749168">+91 9207749168</a></p>
												<img src="images/home/email.svg" alt="email" className="address-icons"/> <span className="address-content">EMAIL</span>
												<p className="address-text"><a href="mailto:info.kochi@hashtag-ca.com" className="link-mail">info.kochi@hashtag-ca.com</a></p>
												<span className="address-content">FOLLOW US </span><a href="https://www.linkedin.com/company/hashtag-systems-inc/" target="_blank"><img src="images/home/linkedin.svg" className="pl-2 pr-2 contact-linkedin"/></a><a href="https://www.facebook.com/hashtagsystemsca/" target="_blank"><img src="images/home/facebook-logo.svg" className="conatct-fb"/></a>
											</div>
												<div className="col-lg-6 col-md-12 col-sm-12">
									  				<div className="hash-map h-100">
									  					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3929.262837900139!2d76.29727491404789!3d9.995134242854492!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b080d1642da3df1%3A0xbe327fe6330aebf3!2sHashtag%20Systems%20India%20Pvt.%20Ltd!5e0!3m2!1sen!2sin!4v1599470444577!5m2!1sen!2sin" className="map-image"></iframe>
