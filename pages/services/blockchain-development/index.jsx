                      ...
                      <div className="row justify-content-center shopify-banner-content pl-3 pr-3">
                        ...
                        <div className="col-lg-6 col-md-12 text-white  ">
                          <h2 className="bold-contents shopify-content-box pl-4">
                            ...
                            internet has been obsessed with the technological
                            marvel that is blockchain technology. We at hashtag
                            being no stranger to advanced technology are among
                            the forefront in blockchain adoption and
                            implementation.
                          </h2>
                        </div>
                      </div>
                  ...
                  <div className="col-lg-5 col-md-12 col-sm-12">
                    ...
                    <div className="shopify-content mt-4">
                      <p className="mb-4">
                        ...
                        blockchain technology brings to the table that which is
                        most sought after, the ability to trust in a trustless
                        environment. Its main selling point is that it is
                        incorruptible. In a world where power is being
                        consolidated more and more in small sectors, the ability
                        to decentralize is being increasingly sought after and
                        blockchain is the way to deliver on that need. The data
                        stored on the blockchain is immutable i.e., it can never
                        be modified or changed by any actor, good or bad.This
                        enables us to leverage blockchain technology to conduct
                        transactions between various groups in an easy, secure
                        and transparent manner.
                      </p>
                      <p>
                        Though blockchain technology has existed for a while, it
                        is now that it has come to the forefront of the tech
                        industry. This is due to the fact that the industry has
                        realised the potential of this technology and that it
                        can leverage this technology to simplify tasks which
                        were otherwise done in a much more complex manner in
                        various industries.
                      </p>
                    </div>
                  </div>
                      ...
                      <div className="col-lg-3 col-sm-6 mob-padding">
                        <div className="what-we-do-border-style what-we-do-responsive">
                          ...
                          <p>
                            ...
                            limitations and objectives to choose the best
                            possible roadmap of a solution to delivering you
                            with what you need..
                          </p>
                        </div>
                      </div>
                    ...
                    <Slide bottom>
                      <div className="col-lg-3 col-sm-6 mob-padding">
                        <div className="what-we-do-border-style what-we-do-responsive">
                          ...
                          <hr class="hashtag-underline ml-2"></hr>
                          <p>
                            We build smart contracts that can once deployed,
                            exist on the chain and in an autonomous manner while
                            remaining secure and reliable.
                          </p>
                        </div>
                      </div>
                    </Slide>
                    <Slide bottom>
                      <div className="col-lg-3 col-sm-6 mob-padding">
                        <div className="what-we-do-border-style what-we-do-responsive">
                          ...
                          <hr class="hashtag-underline ml-2"></hr>
                          <p>
                            We at hashtag are experts on ethereum development
                            and can help you use the second largest blockchain
                            to enhance your business by building applications
                      ...
                      <div className="col-lg-3 col-sm-6 mob-padding">
                        <div className="what-we-do-border-style what-we-do-responsive">
                          ...
                          <p>
                            ...
                            existing business model to drive your business
                            forward.
                          </p>
                        </div>
                      </div>
                    ...
                    <Slide bottom>
                      <div className="col-lg-3 col-sm-6 mob-padding">
                        <div className="what-we-do-border-style what-we-do-responsive">
                          ...
                          <hr class="hashtag-underline ml-2"></hr>
                          <p>
                            Setting up a private blockchain network both locally
                            and on the cloud can have various benefits to your
                            business model. Enable your business to grow and
                            evolve by relying on a private network designed
                    ...
                    <Slide bottom>
                      <div className="col-lg-3 col-sm-6 mob-padding">
                        <div className="what-we-do-border-style what-we-do-responsive">
                          ...
                          <hr class="hashtag-underline ml-2"></hr>
                          <p>
                            We understand your needs and help you realise and
                            verify your idea and its effectiveness within your
                            organization and beyond by building an efficient
                            model capable of proof of concept.
                          </p>
                        </div>
                      </div>
                    </Slide>
                  ...
                  <div className="col-lg-5 col-md-12 col-sm-12">
                    ...
                    <div className="shopify-content mt-4">
                      <p>
                        ...
                        decentralized apps based on solid and customizable
                        Ethereum. Get in touch with us to use the most
                        sophisticated tools and techniques to develop your own
              ...
              <div className="container-fluid ask-expert-section expert-resume-container why-choose-bc-sec">
                <div className="row m-0">
                  <div className="col-12 col-lg-10 col-sm-10 col-md-12 expert-resume-section text-center">
                    <h1 class="main-title title-white text-center main-title-bc-sec-h">
