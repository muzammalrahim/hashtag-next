        ...
        return (
            ...
            <div className="contact-main" id="Blcnbanner">
                <div className="wp-main" id="wp-main">
                    <Header title={data.data.title} description={data.data.description} keywords={data.data.keywords} canonical_tags={data.data.canonical_tags}></Header>
                </div>
                            ...
                            <div className="col-lg-5 col-md-12 col-sm-12">
                                ...
                                <div className="shopify-content mt-4">
                                    <p className="mb-4">
                                        ...
                                        blockchain technology brings to the table that which is most sought after,
                                        the ability to trust in a trustless environment. Its main selling point is
                                        that it is incorruptible. In a world where power is being consolidated more
                                        and more in small sectors, the ability to decentralize is being increasingly
                                        sought after and blockchain is the way to deliver on that need.
                                        The data stored on the blockchain is immutable i.e., it can never be modified
                                        or changed by any actor, good or bad.This enables us to leverage blockchain
                                        technology to conduct transactions between various groups in an easy,
                                        secure and transparent manner.
                                    </p>
                                    <p>
                                        Though blockchain technology has existed for a while, it is now that it has come to
                                        the forefront of the tech industry. This is due to the fact that the industry has
                                        realised the potential of this technology and that it can leverage this technology
                                        to simplify tasks which were otherwise done in a much more complex manner
                                        in various industries.
                                    </p>
                                </div>
                            </div>
                            <div className="col-lg-5 col-md-12 col-sm-12 text-center ">
                                <img src="/images/blockchain/blockchain.svg" alt="blockchain" className="img-fluid shopify-image mobile-image-border storefront-img" />
                            </div>
                                    ...
                                    <div className="col-lg-3 col-sm-6 mob-padding">
                                        <div className="what-we-do-border-style what-we-do-responsive">
                                            ...
                                            <p>
                                                ...
                                                roadmap of a solution to delivering you with what you need..
                                        </p>
                                        </div>
                                    </div>
                                </Slide>
                                    ...
                                    <div className="col-lg-3 col-sm-6 mob-padding">
                                        <div className="what-we-do-border-style what-we-do-responsive">
                                            ...
                                            <p>
                                                ...
                                                and in an autonomous manner while remaining secure and reliable.
                                        </p>
                                        </div>
                                    </div>
                                </Slide>
                                    ...
                                    <div className="col-lg-3 col-sm-6 mob-padding">
                                        <div className="what-we-do-border-style what-we-do-responsive">
                                            ...
                                            <p>
                                                ...
                                                use the second largest blockchain to enhance your business by
                                                building applications that run on the ethereum blockchain.
                                        </p>
                                        </div>
                                    </div>
                                </Slide>
                                    ...
                                    <div className="col-lg-3 col-sm-6 mob-padding">
                                        <div className="what-we-do-border-style what-we-do-responsive">
                                            ...
                                            <p>
                                                ...
                                                can help you use the second largest blockchain to enhance
                                                your business by building applications that run on the ethereum blockchain.
                                        </p>
                                        </div>
                                    </div>
                                </Slide>
                                    ...
                                    <div className="col-lg-3 col-sm-6 mob-padding">
                                        <div className="what-we-do-border-style what-we-do-responsive">
                                            ...
                                            <p>
                                                ...
                                                protocols and API’s into your existing business model to drive your
                                                business forward.
                                        </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-lg-3 col-sm-6 mob-padding">
                                        <div className="what-we-do-border-style what-we-do-responsive">
                                            ...
                                            <p>
                                                ...
                                                can have various benefits to your business model. Enable your business
                                                to grow and evolve by relying on a private network designed specifically
                                                for your benefit.
                                        </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-lg-3 col-sm-6 mob-padding">
                                        <div className="what-we-do-border-style what-we-do-responsive">
                                            ...
                                            <p>
                                                ...
                                                idea and its effectiveness within your organization and beyond by
                                                building an efficient model capable of proof of concept.
                                        </p>
                                        </div>
                                    </div>
                                </Slide>
                    ...
                    <div className="container top-index bg-white">
                        <div className="row justify-content-center pt-5 section-2-row pl-3 pr-3">
                            ...
                            <div className="col-lg-5 col-md-12 col-sm-12">
                                ...
                                <div className="shopify-content mt-4">
                                    <p>
                                        Our creative specialists and expert minds are building decentralized
                                        apps based on solid and customizable Ethereum. Get in touch with us to use
                                        the most sophisticated tools and techniques to develop your own decentralized application.
                                    </p>
                                ...
                                <div className="contact-form-link">
                                    <a href="/careers">
                                        <div className="btn-group form-btn why-choose-bc-sec-btn">
                                            <button type="button" className="btn form-button font-12 font-bold">JOIN US</button>
                                            <button type="button" className="btn form-button-child px-3">
                                                <span className="">
