...
<div className="about-main" id="about-main">
				...
				<div className="container-fluid service-bg p-0 m-0 ">
					...
					<div className="row justify-content-center service-banner-content pl-3 pr-3">
						<div className="col-lg-6 col-md-12">
							<p className="sub-text-above-main-title title-white">Who we are</p>
							<h1 className="main-title title-white d-block">About us</h1>

						</div>
						<div className="col-lg-6 col-md-12 text-white  ">
							<p className="bold-contents service-content-box pl-4">
								Hashtag Systems Inc., is an international Web development company, headquartered in California, provides cutting edge engineering solutions for world-class brands.
							</p>
						</div>	
					</div>
				</div>
	...
	<div class="col-12"><p class="text-above-main-title text-center">PERFECT SOLUTION FOR BUSINESS</p>
	<h1 class="main-title title-orange text-center">Our values</h1>
	<div class="shopify-sub-title text-center">Dedicated to provide best professional Web Solutions</div>
	...
	<p>If you’re looking for custom and complex web development ideas, you have come to the right place. Our talented team with proven figure out the best way to take your business to new heights without ever compromising on the quality.  </p>
	...
	<hr class="hashtag-underline ml-2"/>
	<p>We do not classify our customers into various priority list! We respect our customer’s dream and we believe its importance is immeasurable and incomparable!</p>
	...
	<hr class="hashtag-underline ml-2"/>
	<p>We already have a presence in the United States(San Jose,California) and India (Kochi) and we are happily serving our customers worldwide!</p>
	...
	<p className="text-above-main-title title-black">OUR DREAM TEAM</p>
	<h1 className="main-title"><span class="title-orange d-block"># Team</span></h1>

	<p class="hash-content-col title-black why-us-hash-content">
	<p className="font-normal">From designers, developers to UX specialists, our talented team of experts work together to build beautiful digital presences for your business. We always aim to provide technical excellence, professional service and value for money to our clients
	</p>
	...
	<a href="/careers">
	<div className="btn-group form-btn"><button type="submit" className="btn form-button font-12 font-bold">JOIN US</button><button type="submit" className="btn form-button-child px-3"><span className=""><span className="form-btn-arrow btn-right-arrow border-orange"></span></span></button></div>
	</a>
	</div>
	</div>

	<div className="col-12 col-lg-1 col-md-12">
	...
	<h6 className="title-level-6 title-level-mobile">BAs & 
	<br/>Architects</h6></div>
	...
	<h6 className="title-level-6 title-level-mobile"> Mobile App
	<br/>Developers</h6></div>
	...
	<h6 className="title-level-6 title-level-mobile"> UI \ UX
	<br/>Designers</h6></div>
	...
	<h6 className="title-level-6 title-level-mobile">Web App
	<br/>Developers</h6></div>
	...
	<h6 className="title-level-6 title-level-mobile"> QA
	<br/>Engineers</h6></div>
	...
	<div className="why-us-box">
	<div className="why-us-icon why-icon-mobile">
	<img src="/images/about/performance.svg" alt="performance" />
	</div>
	<h6 className="title-level-6 title-level-mobile">Performance
	<br/>Engineers</h6></div>
	...
	<h6 className="title-level-6 title-level-mobile">Customer
	<br/>Support Engineers</h6></div>
