...
<div className="construction-main" id="construction-main">  <main>
          ...
          <h1 class="main-title banner-main-title text-center"><span class="mobile-white title-orange">Under Maintenance</span></h1>
