            ...
            <header className="header-container">
                ...
                <div className="container" id="main-section">
                    ...
                    <nav className="navbar navbar-expand-lg navbar-light bg-Light">
                        ...
                        <Link href="/">
                            <a aria-current="page" class="navbar-brand active"><img id="logo" class="logo"
                                    ...
                                    <ul className="submenu">
                                        <div className="row m-0">
                                            <div className="col-md-6 p-0">
                                                <li><Link href="/sevices/wordpress-development"><a>Wordpress
                                                    Development</a></Link></li>
                                                <li><Link href="/sevices/blockchain-development">Blockchain
                                                    Development</Link></li>
                                                <li><Link href="/sevices/design-and-prototyping">Design and
                                                    Prototyping</Link></li>
                                            </div>
                                            <div className="col-md-6 p-0">
                                                {/*<li><NavLink to="/services/aws">AWS</NavLink></li>*/}
                                                <li><Link href="/sevices/filemaker">FileMaker Pro Development</Link>
                                                </li>
                                                <li><Link href="/sevices/ui-development">UI Development</Link></li>
                                                <li><Link href="/sevices/database-and-backend">DB & Backend
                                                    Development</Link></li>
